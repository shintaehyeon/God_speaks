...
class _LiveTranslationPageState extends State<LiveTranslationPage> {
      ...
      child: Scaffold(
        ...
        body: Stack(
          children: [
                      ...
                      child: Column(
                        ...
                        children: [
                          Row(
                            ...
                            children: [
                              Text(
                                context.l10n.t('sermonFlowToday'),
                          ...
                          ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              final step =
                                  sermonProvider.sermonFlowSteps[index];
                              final isLast =
                                  index ==
                                  sermonProvider.sermonFlowSteps.length - 1;
                                  ...
                                  children: [
                                    Row(
                                      children: [
                                        ...
                                        Text(
                                          context.l10n.t('liveTranscription'),
                                          style: const TextStyle(
                                            fontSize: 11,
                                            fontWeight: FontWeight.bold,
                                            color: HISpeakTheme.purpleMain,
            ...
            if (showTutorial) _buildTutorialOverlay(context, sermonProvider),
          ],
        ),
        floatingActionButton:
            (sermonProvider.isRecording && !sermonProvider.showTutorial)
            ? FloatingActionButton.extended(
                onPressed: () async {
                  sermonProvider.toggleRecording();
                  ScaffoldMessenger.of(context).showSnackBar(
                    SnackBar(content: Text(context.l10n.t('endAndSummarize'))),
                  );
                  Navigator.pop(context);
                },
                ...
                label: Text(
                  context.l10n.t('endAndSummarize'),
                  style: const TextStyle(
                    color: Colors.white,
                    fontWeight: FontWeight.bold,
                    fontSize: 13,
  ...
  Widget _buildToggleTab(
    String name,
    bool isActive, {
    required bool showFlowSummary,
  }) {
    return Expanded(
      child: GestureDetector(
        onTap: () {
          setState(() {
            _showFlowSummary = showFlowSummary;
          });
        },
        ...
        children: [
          Row(
            children: [
              ...
              const SizedBox(width: 8),
              Text(
                context.l10n.t('tourLiveCaptionTitle'),
                style: TextStyle(
                  fontSize: 16,
                  fontWeight: FontWeight.bold,
                  color: isDark
          ...
          Text(
            context.l10n.t('tourLiveCaptionDesc'),
            style: TextStyle(
              fontSize: 14,
        ...
        children: [
          Row(
            children: [
              ...
              const SizedBox(width: 8),
              Text(
                context.l10n.t('tourLiveOutlineTitle'),
                style: TextStyle(
                  fontSize: 16,
                  fontWeight: FontWeight.bold,
                  color: isDark
          ...
          const SizedBox(height: 12),
          Text(
            context.l10n.t('tourLiveOutlineDesc'),
            style: TextStyle(
              fontSize: 14,
              color: isDark ? const Color(0xFFE2E8F0) : const Color(0xFF334155),
              height: 1.5,
